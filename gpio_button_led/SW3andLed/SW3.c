#include <stdint.h>
// xử dụng interupt để thay đổi led khi ấn button
...
void init_led_and_button(void) {
    ...
    PORTD_PCR5 = PORT_PCR_MUX_GPIO;      // can be replaced by 0x00000100
...
//    // Check if the interrupt is from PTD2 (button SW2 press)
//    if (PORTD_PCR2 & (1U << 24)) {
//        if (GPIOD_PDIR & (1U << 5)) {
//            led_off();
//        } else {
//            led_on();
//        }
//        PORTD_PCR2 |= (1U << 24); // Clear interrupt flag by writing 1 to ISF (Interrupt Status Flag)
//    }
}
